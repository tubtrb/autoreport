...
- Versioned post Markdown under `docs/posts/*.md`, stable standalone page source under `docs/pages/*.md`, and reusable assets under `docs/shared-assets/` are repo-bound by default.
